...
- [Patchies](https://github.com/heypoom/patchies): A tool to build audio-visual patches on the web. Use audio-visual tools such as P5.js, Hydra, Strudel, GLSL, HTML5 Canvas, Generative AI, and patch them together via Smalltalk-style message passing and TouchDesigner-style video chaining. [Try it out at Patchies.app!](https://patchies.app)
