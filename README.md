...
- At day, I work on [Metabase](https://metabase.com), an open-source business analytics tool, as a frontend engineer on the [embedded analytics](https://www.metabase.com/product/embedded-analytics-sdk) team.
- At night, I'm building [Patchies](https://patchies.app), a patcher for audio-visual things that runs on the web. It's made for creative coding; patch objects and code snippets together to make visualizations, soundscapes and artistic explorations. It's also [open-source](https://github.com/heypoom/patchies) and made from open-source tools and libraries.
...
- [Thai UI: Building an open-source system for Thais](https://creatorsgarten.org/videos/cssmeetup0823/thai-ui) for CSS Meetup 2023
